...
// 	tx.BindStateHandler(sip.TransactionStateHandlerFunc(func(ctx context.Context, from, to sip.TransactionState) {
...
// 	restoredTx.BindResponseHandler(sip.InboundResponseHandlerFunc(func(ctx context.Context, res *sip.ResponseEnvelope) {
...
// func createSampleInboundRequest() *sip.RequestEnvelope {
// 	req, err := sip.NewRequestEnvelope(
// 		&sip.Request{
...
// 		},
// 		sip.TransportRef{Proto: "UDP", Addr: netip.MustParseAddrPort("127.0.0.1:5060")},
// 		sip.ConnRef{
// 			LocalAddr:  netip.MustParseAddrPort("127.0.0.1:5060"),
// 			RemoteAddr: netip.MustParseAddrPort("127.0.0.1:5070"),
// 		},
// 	)
// 	if err != nil {
...
// func createSampleOutboundRequest() *sip.RequestEnvelope {
// 	req, err := sip.NewRequestEnvelope(
// 		&sip.Request{
// 			Proto:  sip.ProtoVer20(),
// 			Method: sip.RequestMethodInvite,
...
// 		log.Fatalf("Failed to create request: %v", err) //nolint:revive
// 	}
// 	req.SetTransportRef(sip.TransportRef{Proto: "UDP", Addr: netip.MustParseAddrPort("127.0.0.1:5060")})
// 	req.SetConnRef(sip.ConnRef{
// 		LocalAddr:  netip.MustParseAddrPort("127.0.0.1:5060"),
// 		RemoteAddr: netip.MustParseAddrPort("192.168.1.100:5060"),
// 	})
// 	return req
// }

// func createMockResponse(req *sip.RequestEnvelope, status sip.ResponseStatus) *sip.ResponseEnvelope {
// 	msg, err := req.Message().NewResponse(status, nil)
// 	if err != nil {
// 		log.Fatalf("Failed to create response: %v", err) //nolint:revive
// 	}
// 	connRef := req.ConnRef()
// 	res, err := sip.NewResponseEnvelope(msg, req.TransportRef(), sip.ConnRef{
// 		LocalAddr:  connRef.RemoteAddr,
// 		RemoteAddr: connRef.LocalAddr,
// 	})
// 	if err != nil {
// 		log.Fatalf("Failed to create response: %v", err) //nolint:revive
// 	}
...
// func (*mockServerTransport) SendResponse(ctx context.Context, res *sip.ResponseEnvelope, opts *sip.SendResponseOptions) error {
...
// func (*mockClientTransport) SendRequest(ctx context.Context, req *sip.RequestEnvelope, opts *sip.SendRequestOptions) error {
