...
// 	inReq := newInInviteReq(t, tp.Proto(), "", tp.Addr(), raddr)
...
// 	outReq := newOutInviteReq(t, tp.Proto(), "", tp.Addr(), raddr)
...
// 	got, ok := findTransportStats(report, tp.Proto(), tp.Addr())
// 	if !ok {
...
// 		if stats.Proto == proto && stats.Addr == laddr.String() {
// 			return stats, true
// 		}
// 	}
