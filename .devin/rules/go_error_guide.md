...
## 2. Sentinel Error Message Style
...
func ProcessMessage(msg string) (any, error) {
    if len(msg) == 0 {
        return nil, errors.ErrorWrap("message cannot be empty")
    }
