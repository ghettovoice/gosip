...
//
// Decorators are applied in direct order, so the first decorator in the list
// will be the innermost wrapper.
...
// Decorators are applied in direct order, so the first decorator in the list
// will be the innermost wrapper.
// For example: log -> close-once -> auto-close.
