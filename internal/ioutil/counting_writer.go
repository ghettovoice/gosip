...
func (cw *CountingWriter) Fprint(args ...any) (n int, err error) {
	...
	n, err = fmt.Fprint(cw.Writer, args...)
	cw.num += n
	if err != nil {
		cw.err = err
		return n, errors.Wrap(cw.err)
...
func (cw *CountingWriter) Fprintf(format string, args ...any) (n int, err error) {
	...
	n, err = fmt.Fprintf(cw.Writer, format, args...)
	cw.num += n
	if err != nil {
		cw.err = err
		return n, errors.Wrap(cw.err)
...
func (cw *CountingWriter) Call(fn func(io.Writer) (int, error)) *CountingWriter {
	...
	cw.num += n
	if err != nil {
		cw.err = errors.Wrap(err) // wrap here because no immediate return
	}
